...
const buildPalette = (colorsList) => {
  ...
  for (let i = 0; i < orderedByColor.length; i++) {
    ...
    // Gregg Code: push each generated hexColor into the hexColorArray
    ...
    // Gregg Code to avoid duplicate hex codes
    if (hexColor !== "#FFFFFF") {
      colorElement.appendChild(document.createTextNode(hexColor));
    }
...
/* ====================================================================== */
/* ====================================================================== */
/* OLD WORKING CODE FOR REF */
/* OLD WORKING CODE FOR REF */
// // Gregg Code: create empty array to store generated hexColors
// const hexColorArr = [];
// // Gregg Code: Get SVG Elements
/* OLD WORKING CODE FOR REF */
// // Gregg Code: create empty array to store generated hexColors
// const hexColorArr = [];
// // Gregg Code: Get SVG Elements
// const svgPath1 = document.querySelector(".svg-img path:nth-child(11)");
// const svgPath2 = document.querySelector(".svg-img path:nth-child(7)");
// const svgPath3 = document.querySelector(".svg-img path:nth-child(1)");
// const svgPath4 = document.querySelector(".svg-img path:nth-child(3");
...
//         // Create the HTML structure to show the color palette
//         buildPalette(quantColors);
// 		// Gregg Code: change SVG color to a generated hexColor
// 		svgPath1.style.fill = hexColorArr[12]
// 		svgPath2.style.fill = hexColorArr[13]
// 		svgPath3.style.fill = hexColorArr[14]
// 		svgPath4.style.fill = hexColorArr[15]
// 		// alert(hexColorArr)
// 		downloadSVGasTextFile();
//       };
//       image.src = fileReader.result;
...
//   // Gregg Code
//   a.textContent = "Download your new SVG"
//   const svgDownloadContainer = document.querySelector("#svg-download-container");
//   svgDownloadContainer.appendChild(a)
// 	a.addEventListener("click", () => {
// 	a.download = 'download.svg';
// 	a.href = 'data:text/html;base64,' + base64doc;
